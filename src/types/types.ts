...
export type Games = {
  additional_background?: string | DirectusFiles | null;
  additional_text?: string | null;
  addittional_title?: string | null;
  banner?: string | DirectusFiles | null;
  capsule?: string | DirectusFiles | null;
  date_created?: string | null;
  date_updated?: string | null;
  description?: string | null;
  developer: any[] | GamesDeveloper[];
  features: any[] | GamesFeatures[];
  genre: any[] | GamesGenre[];
  id: number;
  media: any[] | GamesFiles[];
  name?: string | null;
  platform: any[] | GamesPlatform[];
  preview?: string | DirectusFiles | null;
  price?: number | null;
  release_date?: string | null;
  sort?: number | null;
  square_img?: string | DirectusFiles | null;
  status: string;
  user_created?: string | DirectusUsers | null;
  user_updated?: string | DirectusUsers | null;
};

export type GamesDeveloper = {
  collection?: string | null;
  games_id?: number | Games | null;
  id: number;
  item?: string | any | null;
};

export type GamesFeatures = {
  collection?: string | null;
  games_id?: number | Games | null;
  id: number;
  item?: string | any | null;
...
export type GamesFiles = {
  directus_files_id?: string | DirectusFiles | null;
  games_id?: number | Games | null;
  id: number;
};

export type GamesGenre = {
  collection?: string | null;
  games_id?: number | Games | null;
  id: number;
  item?: string | any | null;
...
export type CustomDirectusTypes = {
  ...
  filters: Filters[];
  games: Games[];
  games_developer: GamesDeveloper[];
  games_features: GamesFeatures[];
  games_files: GamesFiles[];
  games_genre: GamesGenre[];
  games_platform: GamesPlatform[];
  genre: Genre[];
  Global: Global;
