...
export interface paths {
  ...
  "/items/games_files": {
    /**
     * List Items
     * @description List the games_files items.
     */
    get: operations["readItemsGamesFiles"];
    /**
     * Create an Item
     * @description Create a new games_files item.
     */
    post: operations["createItemsGamesFiles"];
    /**
     * Delete Multiple Items
     * @description Delete multiple existing games_files items.
     */
    delete: operations["deleteItemsGamesFiles"];
    /**
     * Update Multiple Items
     * @description Update multiple games_files items at the same time.
     */
    patch: operations["updateItemsGamesFiles"];
  };
  "/items/games_files/{id}": {
    /**
     * Retrieve an Item
     * @description Retrieve a single games_files item by unique identifier.
     */
    get: operations["readSingleItemsGamesFiles"];
    /**
     * Delete an Item
     * @description Delete an existing games_files item.
     */
    delete: operations["deleteSingleItemsGamesFiles"];
    /**
     * Update an Item
     * @description Update an existing games_files item.
     */
    patch: operations["updateSingleItemsGamesFiles"];
  };
  "/items/main_banner": {
    /**
     * List Items
     * @description List the main_banner items.
     */
    get: operations["readItemsMainBanner"];
    /**
     * Create an Item
     * @description Create a new main_banner item.
     */
    post: operations["createItemsMainBanner"];
    /**
     * Delete Multiple Items
     * @description Delete multiple existing main_banner items.
     */
    delete: operations["deleteItemsMainBanner"];
    /**
     * Update Multiple Items
     * @description Update multiple main_banner items at the same time.
     */
    patch: operations["updateItemsMainBanner"];
  };
  "/items/main_banner/{id}": {
    /**
     * Retrieve an Item
     * @description Retrieve a single main_banner item by unique identifier.
     */
    get: operations["readSingleItemsMainBanner"];
    /**
     * Delete an Item
     * @description Delete an existing main_banner item.
     */
    delete: operations["deleteSingleItemsMainBanner"];
    /**
     * Update an Item
     * @description Update an existing main_banner item.
     */
    patch: operations["updateSingleItemsMainBanner"];
  };
  "/items/games": {
    /**
     * List Items
     * @description List the games items.
     */
    get: operations["readItemsGames"];
    /**
     * Create an Item
     * @description Create a new games item.
     */
    post: operations["createItemsGames"];
    /**
     * Delete Multiple Items
     * @description Delete multiple existing games items.
     */
    delete: operations["deleteItemsGames"];
    /**
     * Update Multiple Items
     * @description Update multiple games items at the same time.
     */
    patch: operations["updateItemsGames"];
  };
  "/items/games/{id}": {
    /**
     * Retrieve an Item
     * @description Retrieve a single games item by unique identifier.
     */
    get: operations["readSingleItemsGames"];
    /**
     * Delete an Item
     * @description Delete an existing games item.
     */
    delete: operations["deleteSingleItemsGames"];
    /**
     * Update an Item
     * @description Update an existing games item.
     */
    patch: operations["updateSingleItemsGames"];
  };
}
...
export interface components {
  schemas: {
    ...
    ItemsGamesFiles: {
      id?: number;
      games_id?: number | components["schemas"]["ItemsGames"] | null;
    ...
    ItemsMainBanner: {
      ...
      /** Format: timestamp */
      date_updated?: string | null;
      banner?: string | components["schemas"]["Files"];
    ...
    ItemsGames: {
      ...
      genre?: string[];
      features?: string[];
      capsule?: string | components["schemas"]["Files"] | null;
      square_img?: string | components["schemas"]["Files"] | null;
      addittional_title?: string | null;
      additional_text?: string | null;
      additional_background?: string | components["schemas"]["Files"] | null;
      media?: ((number | components["schemas"]["ItemsGamesFiles"])[]) | null;
    };
  };
  responses: {
...
export interface operations {
  ...
  readItemsGamesFiles: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data?: components["schemas"]["ItemsGamesFiles"][];
            meta?: components["schemas"]["x-metadata"];
          };
        };
      };
  ...
  createItemsGamesFiles: {
    ...
    requestBody?: {
      content: {
        "application/json": components["schemas"]["ItemsGamesFiles"][] | components["schemas"]["ItemsGamesFiles"];
      };
    };
    responses: {
      /** @description Successful request */
  ...
  updateSingleItemsGamesFiles: {
    ...
    requestBody?: {
      content: {
        "application/json": components["schemas"]["ItemsGamesFiles"];
      };
    };
    responses: {
      /** @description Successful request */
  ...
  readItemsMainBanner: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data?: components["schemas"]["ItemsMainBanner"][];
            meta?: components["schemas"]["x-metadata"];
          };
        };
      };
  ...
  createItemsMainBanner: {
    ...
    requestBody?: {
      content: {
        "application/json": components["schemas"]["ItemsMainBanner"][] | components["schemas"]["ItemsMainBanner"];
      };
    };
    responses: {
      /** @description Successful request */
  ...
  updateSingleItemsMainBanner: {
    ...
    requestBody?: {
      content: {
        "application/json": components["schemas"]["ItemsMainBanner"];
      };
    };
    responses: {
      /** @description Successful request */
  ...
  readItemsGames: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data?: components["schemas"]["ItemsGames"][];
            meta?: components["schemas"]["x-metadata"];
          };
        };
      };
  ...
  createItemsGames: {
    ...
    requestBody?: {
      content: {
        "application/json": components["schemas"]["ItemsGames"][] | components["schemas"]["ItemsGames"];
      };
    };
    responses: {
      /** @description Successful request */
  ...
  updateSingleItemsGames: {
    ...
    requestBody?: {
      content: {
        "application/json": components["schemas"]["ItemsGames"];
      };
    };
    responses: {
      /** @description Successful request */
...
export type Schema = {
  ...
  games_files: components["schemas"]["ItemsGamesFiles"][];
  main_banner: components["schemas"]["ItemsMainBanner"][];
  games: components["schemas"]["ItemsGames"][];
};
